...
৫। এই ইঞ্জিন বাংলা বইয়ের শিরোনাম ও ফ্ল্যাপের বিবরণের মধ্যে খোঁজে। তাই এমন শব্দ ব্যবহার
   করো যা কোনো বাংলা বইয়ের শিরোনামে বা ফ্ল্যাপে সত্যিই লেখা থাকতে পারে — ইংরেজি শব্দ
   বা বানানো বইয়ের নাম নয়।
৬। কোনো ব্যাখ্যা নয়, শুধু JSON।
