...
এই ইঞ্জিন যা খোঁজে তা হলো বাংলা বইয়ের ক্যাটালগ: প্রতিটি বইয়ের শিরোনাম আর ফ্ল্যাপে
ছাপা বিবরণ। তাই তোমার লেখা প্রতিটি শব্দ এমন হতে হবে যা কোনো বাংলা বইয়ের শিরোনামে
বা ফ্ল্যাপের বিবরণে সত্যিই থাকতে পারে।

নিয়ম:
- keywords: প্রশ্নের মূল বাংলা শব্দ।
- expanded_terms: সমার্থক ও সম্পর্কিত বাংলা পরিভাষা (যেমন "একাত্তর" -> "মুক্তিযুদ্ধ")।
- expanded_terms-এ ইংরেজি শব্দ লিখবে না — ক্যাটালগ বাংলায়, তাই "liberation war" বা
  "short story" কোনো বইয়ের সাথেই মিলবে না। সব শব্দ বাংলায় লেখো।
- expanded_terms-এ কোনো বইয়ের নাম বা লেখকের নাম বানিয়ে লিখবে না; প্রশ্নে যে নাম নেই
  তা যোগ করবে না।
- প্রশ্নকে বেশি সাধারণ করে ফেলবে না। "নারী মুক্তিযোদ্ধা" কে শুধু "মুক্তিযুদ্ধ" বানালে
  প্রশ্নের নির্দিষ্ট অংশটুকুই হারিয়ে যায়।
